...
//                            )
//                            .onTapGesture {
//                                selectedItem = selectedItem == item.name ? nil : item.name // Memperbarui selectedItem hanya jika item saat ini tidak dipilih atau sama dengan item yang sedang dipilih
//                            }
//                            VStack {
//                                Spacer()
//                                HStack {
